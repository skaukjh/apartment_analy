...
const ERROR_GUIDE: Record<string, string> = {
  ...
  '429': '일일 요청 한도를 초과했습니다 (HTTP 429). 자정(KST)에 초기화됩니다.',
 ...
 */
// '429': 쿼터 초과 시 XML(코드 22) 대신 HTTP 429 로 오는 경우가 있다 (Vercel 에서 관측)
export const FATAL_CODES = new Set(['NO_KEY', '10', '20', '22', '30', '31', '32', '429']);
